...
public class BluetoothSPP{
    ...
    public void connect(String address) {
        ...
        if (mBluetoothAdapter == null){
            Log.i("service", "device is null");
        } else  {
            Log.i("service", "device is NOT nulll");
            Log.i("service", device.getAddress());
        }

        if (mChatService == null){
            Log.i("service", "mChatService is null");
        } else  {
            Log.i("service", "mChatService is NOT nulll");
        }
